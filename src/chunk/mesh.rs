...
impl From<&ChunkMesh> for Mesh {
    fn from(chunk_mesh: &ChunkMesh) -> Mesh {
        ...
        info!("chunk_depth: {}", chunk_depth);
        info!("chunk_layers: {}", chunk_layers);
            ...
            for l in 0..chunk_layers {
                for y in 0..chunk_height {
                    for x in 0..chunk_width {
                        ...
                        vertices.push([x0, y0, l as f32]);
                        vertices.push([x0, y1, l as f32]);
                        vertices.push([x1, y1, l as f32]);
                        vertices.push([x1, y0, l as f32]);
                    }
                }
            }
        }
